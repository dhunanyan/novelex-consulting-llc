  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content={PAGES_HTML["life-at-novelex"]["index"].keywords}
        />
        <meta
          name="description"
          content={PAGES_HTML["life-at-novelex"]["index"].description}
        />
        <title>{PAGES_HTML["life-at-novelex"]["index"].title}</title>
      </Head>
    </>
  );
}
