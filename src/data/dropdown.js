export const DROPDOWN_SECTIONS = {
  "who-we-are": {
    ...
    navList: [
      ...
      { id: 2, text: "Our people", href: "/who-we-are/our-people" },
      { id: 3, text: "Global impact", href: "/who-we-are/global-impact" },
      {
        id: 4,
        text: "Diversity and Inclusion",
        href: "/who-we-are/diversity-and-inclusion",
      },
      { id: 5, text: "Climate strategy", href: "/who-we-are/climate-strategy" },
      { id: 6, text: "Our partners", href: "/who-we-are/our-partners" },
    ],
    extraContent: {
  ...
  services: {
    ...
    navList: [
      ...
      { id: 3, text: "Interpretation", href: "/services/interpretation" },
      {
        id: 4,
  ...
  careers: {
    ...
    goToLink: "Go to this section",
    navList: [
      { id: 1, text: "Join Our Team", href: "/careers/join-our-team" },
      {
        id: 2,
        text: "Explore Career Opportunities",
        href: "/careers/explore-career-opportunities",
      },
      { id: 3, text: "Become a Trainer", href: "/careers/become-a-trainer" },
      { id: 4, text: "Where We Hire", href: "/careers/where-we-hire" },
      { id: 5, text: "Find a Job", href: "/careers/find-a-job" },
      {
        id: 6,
